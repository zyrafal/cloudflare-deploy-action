// import { GitHubComment } from "./github-types";

// export default async function printDeploymentLogs({ github, context, fs, customDomain }) {

// }

// // export  async function printDeploymentsLogsOld({ github, context, fs, customDomain }) {
...
//     while (hasMore) {
//       const { data: issueComments }: {data:GitHubComment[]} = await github.rest.issues.listComments({
//         owner: context.repo.owner,
//         repo: context.repo.repo,
//         issue_number: pullRequestNumber,
//         per_page: perPage,
